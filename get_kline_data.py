...
def get_kline_data(ticker: str, interval: int, start_time: dt.datetime):
    ...
    sorted_dates = [date.strftime('%Y-%m-%d %H:%M:%S') for date, _ in sorted_data]
...
dates, prices = get_kline_data_3hour("BTCUSDT", 3)  # тут ебашишь и вызываешь необходимую из 3-х функций( название),
